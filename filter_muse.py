...
if __name__ == '__main__':
    ...
    parser.add_argument('--level', default = '5', type = str, help = 'one of 1,2,3,4,5,all.  level represents the last level that will still be filtered, all implies that all levels will be retained (their filter columns will be converted to PASS).')
